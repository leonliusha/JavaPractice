package CollectionsFrameworkPractices;
...
public class CollectionsFrameworkTest {
	public static void main(String args[]){
		...
		//this inner class ArrayList does not has add() and remove() method, therefore, this return inner class ArrayList
		//can not be resized.
...
//	}
	...
	//One way to get month is to already have money.One way to get a new array of a generic type is to already have an array of that type.
...
//	}
	...
	//this current collection using Mechanisms 1: Copy-on-Write, any change to the value of the collection results in a new array being created
	...
	//this current collection using Mechanisms 2: Compare-and-Swap, it makes a local copy of the variables, when it is ready to update the variable it call CAS,
	...
	//this current collection using Mechanisms 3: java.util.concurrent.locks.Lock
