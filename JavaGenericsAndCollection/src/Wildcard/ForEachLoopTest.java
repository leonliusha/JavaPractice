...
public class ForEachLoopTest {
	...
	//this varargs requires at least one argument.
	//So when we require at least one argument, like 1 or more, we have to use following arguments definition
	public static int min(int firstArg, int...remainArgs){
		int min = firstArg;
	...
	//but the varargs is expensive on the cost of array allocation
	//so, using normal argument definition if the arguments less than n args
	//if more than n, using varargs definition
